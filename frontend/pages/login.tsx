  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Login to your AI-powered component playground" />
      </Head>
        ...
        <main className="relative z-10 w-full max-w-md mx-4">
          <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-2xl">
            <header className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-2">Login to your AI-powered component playground</p>
            </header>
